...
export function NexusSourceCard({ source, index }: NexusSourceCardProps) {
  ...
  return (
    <motion.div
      className="group relative bg-white dark:bg-white border border-gray-200 dark:border-gray-200 rounded-xl overflow-hidden hover:border-blue-300 dark:hover:border-blue-300 transition-all duration-200 hover:shadow-md"
    ...
    >
      ...
      <div className="p-4">
        <div className="flex items-start gap-3 mb-3">
          {/* Domain Favicon */}
          <div className="flex-shrink-0 w-6 h-6 rounded-full bg-white dark:bg-white border border-gray-200 dark:border-gray-200 flex items-center justify-center overflow-hidden">
            {domain ? (
              <img
            ...
            <Globe className={`w-3 h-3 text-black dark:text-black ${domain ? 'hidden' : ''}`} />
          </div>

          {/* Title and Relevance */}
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between gap-2 mb-2">
              <h4 className="font-medium text-sm text-black dark:text-black leading-tight pr-2">
                {source.title}
              </h4>
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                <div className="flex items-center gap-1">
                  <span className="text-xs text-black dark:text-black">{t('relevance')}:</span>
            ...
            {/* Progress Bar */}
            <div className="relative h-1.5 bg-white dark:bg-white rounded-full overflow-hidden mb-3 border border-gray-200">
              <motion.div
            ...
            {/* Snippet Preview */}
            <p className="text-xs text-black dark:text-black leading-relaxed line-clamp-2">

...
const copy = {
  es: {
    ...
    clarity: {
      ...
      asyncNote: "Cuando la recepción esté legalmente aprobada, la solicitud quedará en una cola segura aunque mi ordenador esté apagado. Una primera lectura asistida por Gemma se ejecutará localmente más tarde y yo revisaré cualquier respuesta.",
      ...
      location: "Ciudad / país (opcional)",
      consentPending: "El texto final de consentimiento y conservación está pendiente de aprobación. La recepción pública permanece desactivada.",
  ...
  en: {
    ...
    clarity: {
      eyebrow: "Project Clarity", title: "Clarify the project before building.", intro: "Six questions to organise the blockage, context and worthwhile outcome. This is not a chatbot or an instant answer.", asyncNote: "Once intake has legal approval, the request will enter a secure queue even when my computer is off. A local Gemma-assisted first read will run later and I will review every reply.", progress: "Question {current} of 6", stepAnnouncement: "Question {current} of 6: {title}",
      questions: [
  ...
  fr: {
    ...
    clarity: {
      eyebrow: "Project Clarity", title: "Clarifier le projet avant de construire.", intro: "Six questions pour ordonner le blocage, le contexte et le résultat qui mérite l’effort. Ce n’est ni un chatbot ni une réponse instantanée.", asyncNote: "Une fois la réception approuvée juridiquement, la demande rejoindra une file sécurisée même si mon ordinateur est éteint. Une première lecture assistée par Gemma sera effectuée localement plus tard et je relirai chaque réponse.", progress: "Question {current} sur 6", stepAnnouncement: "Question {current} sur 6 : {title}",
      questions: [
